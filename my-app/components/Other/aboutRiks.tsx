    ...
    return (
        <div>
            <div className="text-center">
                <h1 className="font-bold text-4xl mt-20 bg-gradient-to-r from-cyan-500 to-blue-500 inline-block text-transparent bg-clip-text"> Vem styr Sverige? </h1>
            ...
            <div className="px-4 pt-16">
                <div className="flex flex-wrap justify-center">
                    ...
                    <Card className="m-4 p+2 w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/3">
                        ...
                        <CardContent>
                            <p>Regeringen utgör en central del av den svenska politiska processen och har en avgörande roll i att driva landets utveckling och förvalta dess lagstiftning. Efter varje riksdagsval är det det parti eller den partikoalition som får flest röster som har möjlighet att bilda regering. Talmannen har i uppgift att nominera en statsminister för den nyvalda riksdagen, som sedan måste godkännas av riksdagen för att officiellt tillträda som regeringschef. Som regeringschef har statsministern makten att utse övriga ministrar, eller statsråd, som tillsammans utgör regeringen. Dessa ministrar ansvarar för olika politikområden och arbetar tillsammans för att genomföra regeringens politiska agenda. Regeringen är följaktligen ansvarig gentemot riksdagen och måste kunna få dess stöd för att genomföra sina politiska mål och beslut. För att underlätta sitt arbete har regeringen tillgång till ett omfattande regeringskansli, organiserat i olika departement, som hanterar specifika frågor inom samhället. Dessutom finns det statliga myndigheter och bolag som verkar under regeringens ledning och stödjer dess arbete inom olika sektorer såsom utbildning, hälsa, och infrastruktur. Genom denna komplexa struktur samarbetar regeringen med riksdagen och andra statliga organ för att formulera och genomföra lagar och politiska åtgärder som syftar till att främja Sveriges samhällsutveckling och välfärd.</p>
                        </CardContent>
                    </Card>
                </div>
            </div>
